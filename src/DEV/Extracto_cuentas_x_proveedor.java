...
public class Extracto_cuentas_x_proveedor extends javax.swing.JFrame {

    public Extracto_cuentas_x_proveedor() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Extracto de Cuenta");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Metodos.Extracto_Compras_imprimir_proveedor_x_cuenta(jDateChooser_desde.getDate(), jDateChooser_hasta.getDate());
    ...
    private void jTable_proveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable_proveedorKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Metodos.Extracto_compras_proveedor_x_cuenta_selected();
            jDialog_proveedor.setVisible(false);
        }
    ...
    private void jTextField_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_buscarKeyReleased
        if ((evt.getKeyCode() == KeyEvent.VK_DOWN)) {
            ...
            Metodos.Extracto_compras_proveedor_x_cuenta_jtable(jTextField_buscar.getText());
        }
