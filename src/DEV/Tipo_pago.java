...
public class Tipo_pago extends javax.swing.JFrame {
    ...
    public static void Clear() {
        jt_tipo.setText("");
        Metodos.id_tipo_pago = 0;
        jt_tipo.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jt_tipo.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo de Pago"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Metodos.Tipo_pago_Guardar(jt_tipo.getText());
        Clear();
...
//        }
    ...
    private void jt_tipoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jt_tipoKeyPressed
...
//        }
    ...
    }//GEN-LAST:event_jt_tipoKeyPressed
